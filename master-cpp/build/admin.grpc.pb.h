...
class DataNodeAdmin final {
 public:
  ...
  class WithAsyncMethod_AdminOrder : public BaseClass {
   ...
   public:
    WithAsyncMethod_AdminOrder() {
      ::grpc::Service::MarkMethodAsync(0);
    }
    ~WithAsyncMethod_AdminOrder() override {
  ...
  typedef WithAsyncMethod_AdminOrder<Service > AsyncService;
  template <class BaseClass>
  class WithCallbackMethod_AdminOrder : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
  ...
  template <class BaseClass>
  class WithGenericMethod_AdminOrder : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithGenericMethod_AdminOrder() {
      ::grpc::Service::MarkMethodGeneric(0);
    }
    ~WithGenericMethod_AdminOrder() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status AdminOrder(::grpc::ServerContext* /*context*/, const ::gridfs::AdminOrderRequest* /*request*/, ::gridfs::AdminOrderResponse* /*response*/) override {
  ...
  template <class BaseClass>
  class WithRawMethod_AdminOrder : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawMethod_AdminOrder() {
      ::grpc::Service::MarkMethodRaw(0);
    }
    ~WithRawMethod_AdminOrder() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status AdminOrder(::grpc::ServerContext* /*context*/, const ::gridfs::AdminOrderRequest* /*request*/, ::gridfs::AdminOrderResponse* /*response*/) override {
    ...
    void RequestAdminOrder(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(0, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  class WithRawCallbackMethod_AdminOrder : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawCallbackMethod_AdminOrder() {
      ::grpc::Service::MarkMethodRawCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->AdminOrder(context, request, response); }));
    }
    ~WithRawCallbackMethod_AdminOrder() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status AdminOrder(::grpc::ServerContext* /*context*/, const ::gridfs::AdminOrderRequest* /*request*/, ::gridfs::AdminOrderResponse* /*response*/) override {
  ...
  template <class BaseClass>
  class WithStreamedUnaryMethod_AdminOrder : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ...
    ~WithStreamedUnaryMethod_AdminOrder() override {
      BaseClassMustBeDerivedFromService(this);
    }
